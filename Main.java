    ...
    public static void main(String[] args) {
        ...
        while (pilih != 4) {
            switch (pilih) {
                    ...
                    if (choice == 1) {
                        ...
                        while (iterator.hasNext()) {
                            ...
                            if (curennode.getNamaTugas().equalsIgnoreCase(diHapus)
                                    || curennode.getNamaMatkul().equalsIgnoreCase(diHapus)
                ...
                case 3:
                    for (data data : list) {
                        System.out.println(data.getNamaMatkul() + " " + data.getNamaTugas() + " " + data.getDeadline());
                    }
                    break;
            }
            System.out.println("1. Input tugas");
